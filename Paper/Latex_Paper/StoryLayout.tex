...
% Consider slightly broadening the title to capture the LLM aspect, e.g.:
% "A Hybrid Rule-Based Verifier for Thai Poetry: Bridging Educational Tools and LLM Reward Models"
...
\IEEEauthorblockA{\textit{School of Information, Computer, and Communication Technology} \\
